            ...
            <section class="py-10 bg-white">
                <div class="px-4 mx-auto max-w-7xl ">
                    <div class="grid grid-cols-1 gap-6 px-6 sm:px-0 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
                        <div class="stats-box overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                        ...
                        <div class="stats-box overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-4xl font-bold text-gray-900">250+</h4>
                                        <p class="mt-1.5 text-lg font-medium leading-tight text-gray-500">Our customers</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="stats-box overflow-hidden bg-white border border-gray-200 rounded-lg">
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-4xl font-bold text-gray-900">1200+</h4>
                                        <p class="mt-1.5 text-lg font-medium leading-tight text-gray-500">Product delivered</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="px-4 py-6">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-1.5 text-lg font-medium leading-tight text-gray-500">Customer Feedbacks</p>
                                    </div>
                                </div>
                            </div>
                        </div>
